...
**Home**
- [x] Kennedy Krieger Application
- [x] Contact Bird Guy to clean Gutters

**Work**
- [ ] Practice workshop (ideally in Studio?)

**Studio Queral**
- [ ] (Very) Oblique Strategies
- [ ] Generative Design
- [x] R
...
### Notes —
- "How do we have the confidence that this is going to work"
- "White smoke event"
- "How do we help support other teams in doing what they need to do?"
- Ask Sylvia if we can get Brian Eno to speak with the PD team? Is that insane or in the realm of possibility?


### Notes — Thursday *Generative Design* Ideation Session

### Notes — Generative Design
- Play Day
	- Cursor Tutorial / Docs
	- Rehearse
	- Messaging
- When talking to leadership maybe "Cost Efficiency" is something to lean into?
- Maybe there's an exercise we can do when we can talk about *Generative Design* to several difference audiences…
	- **Design**
		- IC
		- Leadership
	- **Engineering**
...
- *Very* Oblique Strategy Cards – More of a thought exercise, but these have been getting more interesting to me. Definitely less on the "getting people started" with generative thinking and more provocative (and frankly entertaining).

<figure>
  <img src="https://mp1ewwuojwmnpxpy.public.blob.vercel-storage.com/image_1747233929605-LLXvS1FZbO1z0m997lThGgcwz0jeWt.webp" width="auto" class="ba b--light-gray bw2 br2">
